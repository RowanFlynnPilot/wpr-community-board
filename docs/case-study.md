...
public announcement. The weekly newsletter block is generated by one
button on the editor's desk, deep links included. And a print stylesheet
turns the live board into a clean two-column "From the Community Board"
page for the paper — closing the loop back to the corkboard the design
came from.
